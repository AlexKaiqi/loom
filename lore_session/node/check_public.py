...
def main():
 ...
 def setup(name):
  ...
  model={'id':'deepseek-v4-flash','name':'keyless finite callback','api':'lore-proxy-completions','provider':'lore-authorized-proxy','baseUrl':'http://localhost:0','reasoning':False,'input':['text'],'cost':{'input':0,'output':0,'cacheRead':0,'cacheWrite':0},'contextWindow':131072,'maxTokens':2048}
