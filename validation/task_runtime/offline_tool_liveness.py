...
Fixture: validation/task_runtime/fixture_liveness/ (declares sys.tool.started /
...
from lore_task import facts as facts_mod  # noqa: E402
from lore_task import layout  # noqa: E402
from lore_task import round as round_mod  # noqa: E402

FIXTURE = ROOT / "validation" / "task_runtime" / "fixture_liveness"
...
def run_case(case, responses, **kwargs):
    ...
    base = layout.create_task(root, case, FIXTURE)
