...
"""Independent checker for a system-design task directory.
...
Usage: python3.12 verify_design_task.py <task-dir>
"""
import argparse
import hashlib
import json
...
def main() -> int:
    ...
    print(json.dumps({"task": str(base), "units": unit_ids, "kinds": kinds, "ok": ok}, ensure_ascii=False))
