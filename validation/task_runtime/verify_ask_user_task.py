...
"""Independent checker for an ask-user task directory (reads only on-disk artifacts).

Usage: python3.12 verify_ask_user_task.py <task-dir>
"""
import argparse
import hashlib
import json
...
def main() -> int:
    ...
    expected = ["task.objective.set", "ask.requested", "ask.answered", "sys.tool.result", "task.completed"]
