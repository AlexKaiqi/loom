"""Finite preregistered live F driver. Missing implementation is never green."""
...
plan=json.loads((ROOT/'design/g3/f/cases.json').read_text());expected=[x['id'] for x in plan['cases']]
