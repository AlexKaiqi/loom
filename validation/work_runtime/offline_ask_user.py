...
ROUND_2 = [
    ...
    json.dumps({"action": {"type": "emit", "kind": "work.completed", "payload": {"evidence_refs": ["answer.md"]}}}),
]
...
def main() -> int:
    ...
    check("no_completion_yet", "work.completed" not in kinds_1, str(kinds_1))
    ...
    check("completed_once", kinds_2.count("work.completed") == 1, str(kinds_2))
    ...
    print(json.dumps({"work_root": str(root), "kinds": kinds_2}, ensure_ascii=False))
