...
"""Independent checker for a research work directory.
...
Usage: python3.12 verify_research_work.py <work-dir>
"""
import argparse
import hashlib
import json
...
def main() -> int:
    ...
    # it must not be required to vanish for the work to finish (self-healing).
    ...
    check("saturation_before_completion",
          "research.saturation.reached" in kinds and "work.completed" in kinds
          and kinds.index("research.saturation.reached") < kinds.index("work.completed"), str(kinds))
