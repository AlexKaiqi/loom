...
def main() -> int:
    ...
    check("A_not_complete_yet", "work.completed" not in kinds_a1, str(kinds_a1))
    ...
    check("A_completed_once", kinds_a2.count("work.completed") == 1, str(kinds_a2))
    ...
    check("C_completion_blocked", "work.completed" not in kinds_c, str(kinds_c))
    ...
    check("C_still_not_complete", "work.completed" not in kinds_c2, str(kinds_c2))
    ...
    check("C_completed_after_reaccept", kinds_c3.count("work.completed") == 1, str(kinds_c3))
    ...
    print(json.dumps({"work_root": str(root), "work_c_kinds": kinds_c3}, ensure_ascii=False))
